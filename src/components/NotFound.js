...
const NotFound = () => {
    return (
        <>
            <div
                className="min-w-screen min-h-screen bg-blue-100 flex items-center p-5 lg:p-20 overflow-hidden relative">
                <div
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="mb-10 md:mb-20 text-gray-600 font-light">
                            <h1 className="font-black uppercase text-3xl lg:text-5xl text-a_red mb-10">You seem to
                                be
                                lost!</h1>
                        ...
                        <div className="mb-20 md:mb-0">
                            <Link to={'/about'}>
                                <button
                                    className="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-a_red hover:text-a_rose">
                    ...
                    <div className="w-full md:w-1/2 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.85 285.44"
                            ...
                            <g id="OBJECTS">
                                ...
                                <g>
                                    ...
                                    <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="242.075"
                                                    y1="248.234"
                                    ...
                                    <ellipse transform="rotate(-9.249 191.082 198.565)" className="st6" cx="191.05"
                                             cy="198.49"
                                             rx="9.23" ry="9.23"/>
                                    <path className="st4"
                                    ...
                                    <ellipse transform="rotate(-9.249 292.07 198.575)" className="st6" cx="292.01"
                                             cy="198.49"
                                             rx="9.23" ry="9.23"/>
                                    <path className="st4"
                                ...
                                <g>
                                    ...
                                    <circle className="st-sun" cx="97.11" cy="40.45" r="26.45"/>
                                    <path className="st-sun-shadow"
                        ...
                        <a href="https://www.freepik.com/vectors/business" target="_blank"
                           className="text-xs text-gray-300">Business
                            vector created by pikisuperstar - www.freepik.com</a>
                    </div>
                </div>
                <div
